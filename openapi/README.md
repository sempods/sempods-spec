...
`x-sps-requirements`. [Issue #77](https://github.com/sempods/sempods-spec/issues/77) tracks the
OpenAPI fidelity candidates and their evidence against the affected operations. A description's
omission does not remove the chapter's obligation.
