...
The normative text lives in this directory: six core chapters and four modules, 316 requirements.
...
| [`core/contexts.md`](core/contexts.md) — the context as the permission boundary, the `_system/contexts` namespace, discovery, and the control-plane boundary | `CTX` | **present** | `docs/auth/authorization.md` |
...
|---|---|---|---|
| [`modules/context-management.md`](modules/context-management.md) — creating and deleting contexts: the management route, naming rules, delegation types, lifecycle | `CTX` | **present** | `spec/core/contexts.md`, split |
