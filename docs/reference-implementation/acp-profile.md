...
It lives here rather than in the implementation repository for as long as this text can still move
([`../../GOVERNANCE.md`](../../GOVERNANCE.md)) and the two are being worked out together. When that
stops being true it moves, and nothing in the specification has to move with it.
