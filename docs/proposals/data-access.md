...
| [`Auth`](../../spec/core/auth.md), especially [`SPS-AUTH-013`](../../spec/core/auth.md#SPS-AUTH-013), [`SPS-AUTH-024`](../../spec/core/auth.md#SPS-AUTH-024) | Apply the [authorization recommendation and impact map](access-control.md#authorization-without-context-setup), including Context-free consent/service authority, S256 PKCE and conditional state echo. Complete the remaining identity/discovery/profile decisions before adoption. |
